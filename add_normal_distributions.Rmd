...
For the standard deviation, it appears to be a bit trickier. But a quick search reveals that the standard deviation of $X + Y$ is equal to $\sqrt{\sigma^2_{X} + \sigma^2_{Y}}$. Let's check this using R:
```{r}
sd(distb_df$`X + Y`)
